...
home_directory_button.grid(row=0, column=0)     #location of button
...
macro_name_label.grid(row=2, column=0)
...
data_folder_label.grid(row=3, column=0)
...
data_folder_button.grid(row=3, column=1, padx=(150,5) )     #location of button
...
###
rocking_frame = tkinter.LabelFrame(frame, text="Rocking")
rocking_frame.grid(row=3, column=0, columnspan=2, pady=(0, 10))
...
rock_lpx_label.grid(row=0, column=1)
# rock_lpx_label.config(state="disabled")

rock_lpx_var = tk.StringVar()
...
rock_lpy_label.grid(row=0, column=2)
# rock_lpy_label.config(state="disabled")

rock_lpy_var = tk.StringVar()
rock_lpy_entry = tk.Entry(rocking_frame, width=10, textvariable=rock_lpy_var)
rock_lpy_entry.grid(row=1, column=2)
# rock_lpy_entry.config(state="disabled")
...
sample_param_frame.grid(row=4, column=0, padx=10, pady=(0,10))
...
sample_count_dropdown.grid(row=0, column=1, padx=5, pady=5)

# Dictionary to store user input
sample_parameters = {}

# Button to open sample entry popup
enter_samples_button = tk.Button(sample_param_frame, text="Enter Sample Information", command=lambda: open_sample_popup(sample_count_var,sample_parameters))
enter_samples_button.grid(row=0, column=2, padx=5, pady=5)



###
cameras_frame=tkinter.LabelFrame(frame, text="Camera Parameters")
cameras_frame.grid(row=5, column=0, padx=10, pady=(0,10))

cameras_label = tk.Label(cameras_frame, text="What cameras do you want to use?")
cameras_label.grid(row=0, column= 0)
