...
def open_manual_data_popup(sample_data):
    popup = tk.Toplevel(root)
    popup.title("Enter in Data Manually")

    tk.Label(popup,
             text="One set of data per line.",
...
# Button to open Excel-style paste popup
enter_excel_button = tk.Button(sample_param_frame, text="Enter Sample Information",
                               command=lambda: open_manual_data_popup(sample_parameters), bg="PaleTurquoise1",
                               fg="black")
enter_excel_button.grid(row=0, column=0, padx=5, pady=5)
###
